...
/**
 * Interface that represents factories that can generate IAttachmentOfEarningsCalculator implementations.
 */
export interface IAttachmentOfEarningsCalculatorFactory {
  /**
